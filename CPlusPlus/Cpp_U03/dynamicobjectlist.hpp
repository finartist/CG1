...
public:
  ...
  void reserve(const unsigned int capacity); // TODO: Implement in cpp.
  ...
  void destroyObject(const unsigned int position); // TODO: Implement in cpp.
  ...
  Object* getAt(const unsigned int position) const; // TODO: Implement in cpp.
