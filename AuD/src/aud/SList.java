 ...
 * href="http://www.sgi.com/tech/stl/Slist.html">std::slist</a>) of
 ...
 * {@link Iterator#hasNext} checks whether the <em>current</em> entry
 * is valid, and {@link Iterator#next} returns the current entry whil
 * advancing to the subsequent entry. <p> <em>This is the standard
