...
/** Simple binary tree.<p>

  The {@code BinaryTree} class represents a <em>node</em> and
...
public class BinaryTree<T>
  ...
  public BinaryTree<T> getParent() { return parent_; }
  /** get left child or {@code null} */
  public BinaryTree<T> getLeft() { return left_; }
  /** get right child or {@code null}) */
  public BinaryTree<T> getRight() { return right_; }
  ...
  /** Get preorder iterator over nodes in tree .<p>
      Examples: <p>
      {@code Iterator<BinaryTree<T> > ii=tree.preorder().iterator();}<p>
  ...
  /** Get inorder iterator over nodes in tree .<p>
      @return instance of {@code Iterable}
      @see #preorder
  ...
  /** Get postorder iterator over nodes in tree .<p>
      @return instance of {@code Iterable}
      @see #preorder
  ...
  /** Get level-order iterator over nodes in tree .<p>
      @return instance of {@code Iterable}
      @see #preorder
  ...
  /** Get name for "referencing a node.<p>
      Unlike in graphs, {@link #getData} can appier multiple times,
      i.e., nodes may contain the same "data". Using {@code dotRef}
      prevents GraphViz from eventually misinterpreting the data and
      drawing a graph with cycles.
   */
   ...
   */
  protected String dotLabel() { return getData().toString(); }
  ...
  private String toText(int level) {
    String text="";
    text+=Sys.indent(level)+"+- "+textLabel()+"\n";
   ...
   */
  protected String textLabel() { return getData().toString(); }
